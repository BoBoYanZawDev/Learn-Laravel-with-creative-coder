  ...
  <div class="flex lg:flex-row flex-col gap-5 xl:px-32 sm:px-5 px-2 mt-10 mb-10">
    <div class="basis-[60%]">
      ...
      @enderror
          ...
          <div class="md:col-span-2 flex flex-col justify-center">
            ...
            <input name="shopping_address" value="{{old('shopping_address')}}"
              class="md:col-span-2 outline-none px-3 focus:ring-0 border-[1px] border-black/10 py-4 rounded-lg focus:border-primary transition-all mt-2"
      ...
      @enderror
          ...
          <div class="flex md:col-span-2 flex-col">
            ...
            <textarea name="notes" rows="5"
              class="outline-none focus:ring-0 border-[1px] border-black/10 py-4 rounded-lg focus:border-primary transition-all mt-2">{{old('notes')}}</textarea>
            @error('notes')
        <p class="text-red-500 my-3 text-sm">{{$message}}</p>
      @enderror
          </div>
      ...
      <div class="mt-6 border-[1px] border-black/10 px-6 pt-8 pb-8">
        ...
        <div class="font-bold flex gap-2 shrink-0">
          ...
          <button type="submit">
            ...
            <path fill="red" d="M5 21V6H4V4h5V3h6v1h5v2h-1v15zm2-2h10V6H7zm2-2h2V8H9zm4 0h2V8h-2zM7 6v13z" />
            </svg>
          </button>
          </form>
        </div>
    ...
    @endforelse
        ...
        <div class="mt-8">
          ...
          <div class="mt-5 flex-col gap-3">
            ...
            <div>
              ...
              <img class="w-[300px] mx-auto h-auto"
        ...
        <div class="flex items-center cursor-pointer gap-2">
          <input id="termandcondition" type="checkbox" class="outline-none focus:ring-0 border-2 border-black/10"
            name="" />
          <label for="termandcondition" class="text-sm font-bold text-black/50 my-4">I have read and agree to the
            website
