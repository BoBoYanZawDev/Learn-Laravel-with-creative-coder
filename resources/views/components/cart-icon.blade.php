<div>
    <a href="{{route('checkout')}}" class="flex items-center cursor-pointer text-white">
        <div class="flex items-center">
            <p class="w-[25px] rounded-full flex text-sm items-center justify-center h-[25px] bg-primary">
                {{$cartCount ?? 0}}
            </p>
            <svg class="md:w-[50px] w-[30px] h-[50px] md:h-[80px]" xmlns="http://www.w3.org/2000/svg" width="32"
